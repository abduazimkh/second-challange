          ...
          <div className="user__info-wrapper">
            <div className="user__info-card card">
              <div className="info__top-header">
                <img className='user-avatar' src={state.data.avatar} alt="H" />
                <button className='edit-btn'><FaEdit /></button>
              </div>
              <h2 className="user__fullname">{state?.data?.name} {state?.data?.last_name}</h2>
              <p className='username-link'>{state.data.email}</p>
            </div>
